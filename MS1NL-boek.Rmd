...
critical investigation of natural phenomena. It is guided by theory and hypotheses about the presumed relations among such phenomena" [@KL00, p.14].
...
ook relatief langer in leven zijn[^1]. Om vast te kunnen stellen of er
...
[^1]: Het is zelfs mogelijk dat het onderzochte voedingspatroon de
    oorzaak is van een relatief *kortere* levensduur, maar dat dit
    negatieve effect gemaskeerd wordt door de sterkere, positieve
    effecten van opleidingsniveau en welvaartsniveau op de levensduur.

<!--chapter:end:h01inleiding.Rmd-->

`r if (knitr:::is_html_output()) '
# Referenties {-}
'`

<!--chapter:end:referenties.Rmd-->

...
\author{true}
\date{Versie gecompileerd op 23 Sep 2020}
...
De tekst is geschreven in LaTeX, en daarna omgezet naar Rmarkdown, met behulp van \texttt{pandoc} en het \texttt{bookdown} package \citep{R-bookdown} in \href{https://www.rstudio.com}{Rstudio}.\\
De broncode van de tekst en voorbeelden (in Rmarkdown), en de bijbehorende databestanden en figuren, zijn beschikbaar via \url{https://github.com/hugoquene/MS1NL-boek/} .
...
verwachte frequentie is identiek voor iedere cel. De geobserveerde
...
zou natuurlijk ook toeval kunnen zijn. De geeft aan hoe groot de kans is
op deze ``scheve'' verdeling van uitkomsten, als H0 waar is. De verwachte
...
De gevonden significantie \(p\) is kleiner dan \(\alpha=.05\), en dus

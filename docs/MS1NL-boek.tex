...
populaties. In het geval van de en van ANOVA gaan die uitspraken over
...
\begin{longtable}[]{@{}lccc@{}}
\toprule
& rood & grijs & blauw\tabularnewline
\midrule
\endhead
~~contrast 1 & \(-1\) & \(+0.5\) & \(+0.5\)\tabularnewline
~~contrast 2 & \(0\) & \(-1\) & \(+1\)\tabularnewline
\bottomrule
\end{longtable}
...
hun respectievelijke gewichten voor iedere conditie (kolom):\\
...
technieken uit Deel II van deze syllabus (met name
§\ref{sec:isvarnormaalverdeeld}).

...
[^fn09-1]: In het Engels wordt de streep in het midden van een weg aangeduid
als de "median"; deze streep verdeelt de weg in twee even brede helften.

[^fn09-2]: http://www.cbs.nl/nl-NL/menu/themas/inkomen-bestedingen/cijfers/extra/inkomensverdeling.htm

[^fn09-3]: Dit is vergelijkbaar met sporten als roeien, zwemmen, wielrennen,
schaatsen, e.d., waar ook de tijd over een afgesproken afstand
gemeten en vergeleken wordt, en niet de snelheid over een afgesproken tijd.

[^fn09-4]: In een klassieke boxplot strekken de lijnen zich uit naar het
minimum en maximum [@Tukey77] en worden uitbijters niet apart
aangeduid.

[^fn09-5]: We delen door $n-1$ en niet door $n$, om een betere schatting te
    krijgen van de spreiding in de *populatie*. Op deze manier houden we
    ...
    geïnteresseerd bent in de spreiding in je *steekproef* van
    observaties, en niet in de populatie, deel dan door $n$.

[^fn09-6]: Positieve afwijkingen blijven ongewijzigd, van negatieve
    afwijkingen wordt het teken omgekeerd.

[^fn09-7]: <https://nl.wikipedia.org/wiki/Significant_cijfer>

[^fn09-8]: Deze "odds" geeft aan dat er 23 geslaagden zijn op 6 gezakten,
    d.i. afgerond 4 geslaagden voor iedere gezakte.

[^fn09-9]: Check: $z = +2 = \frac{(x_i-\overline{x})}{s_x}$, dus
